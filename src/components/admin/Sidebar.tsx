...
import { LayoutDashboard, Image as ImageIcon, Settings, Users, Building2, LogOut, X, ChevronLeft, Shield, CreditCard } from 'lucide-react';
...
const sidebarItems: SidebarItem[] = [
    ...
    { name: 'Subscriptions', href: '/admin?view=subscriptions', icon: CreditCard },
];
